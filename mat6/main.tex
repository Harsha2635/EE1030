...
\renewcommand{\thetable}{\theenumi}
\textbf{Question}:\\
Using integration, find the area of the region bounded by the parabola $y^2\;=\;4x$ and th ecircle $4x^2+4y^2\;=\;9$.
\\
\solution
\begin{table}[h!]    
  \centering
...
\begin{align}
\myvec{\frac{1}{2}\\\sqrt{2}}\;,\;\myvec{\frac{1}{2}\\-\sqrt{2}}
\end{align}
Area between the curves is,
\begin{align}
2\int_{0}^{\sqrt{2}} \brak{\sqrt{\frac{9}{4}-y^2}-\frac{y^2}{4}} \, dy \\
\end{align}
By solving the integration, we get area is equal to 3.06 sq.units
\begin{figure}[h!]
   \centering
